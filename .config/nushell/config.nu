...
let dark_theme = {
    ...
    # eg) {|| if $in { 'light_white' } else { 'light_gray' } }
    bool: light_white
    int: white
    filesize: white
    duration: white
    ...
    shape_and: red_bold
    shape_binary: red_bold
    shape_block: blue_bold
    shape_bool: light_white
    shape_closure: white_bold
    shape_custom: white
    shape_datetime: white_bold
    ...
    shape_keyword: white_bold
    shape_list: white_bold
    shape_literal: blue
    shape_match_pattern: white
    shape_matching_brackets: { attr: u }
    shape_nothing: light_white
    shape_operator: yellow
    shape_or: red_bold
    shape_pipe: red_bold
    shape_range: yellow_bold
    shape_record: white_bold
    shape_redirection: red_bold
    shape_signature: white_bold
    shape_string: white
    shape_string_interpolation: white_bold
    shape_table: blue_bold
    shape_variable: red
    shape_vardecl: red
    shape_raw_string: light_red
}
...
let light_theme = {
    ...
    # Closures can be used to choose colors for specific values.
    # The value (in this case, a bool) is piped into the closure.
    # eg) {|| if $in { 'dark_white' } else { 'dark_gray' } }
    bool: dark_white
    int: dark_gray
    filesize: white_bold
    duration: dark_gray
    ...
    shape_external: white
    shape_externalarg: white_bold
    shape_external_resolved: light_red_bold
    shape_filepath: white
    shape_flag: blue_bold
    shape_float: red_bold
    # shapes are used to change the cli syntax highlighting
